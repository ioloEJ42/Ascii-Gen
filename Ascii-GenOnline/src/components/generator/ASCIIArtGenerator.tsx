        ...
        <div className="space-y-4">
          <Tabs defaultValue="shape" className="w-full">
            ...
            <TabsContent value="shape">
              <ShapeSelector
                shape={config.shape}
                setShape={(shape) => setConfig({ ...config, shape })}
                size={config.size}
                setSize={(size) => setConfig({ ...config, size })}
              />
            </TabsContent>
            <TabsContent value="pattern">
              <PatternSelector
                pattern={config.pattern}
                setPattern={(pattern) => setConfig({ ...config, pattern })}
              />
              <div className="mt-4">
                <label
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setConfig({ ...config, characters: e.target.value })
                  }
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={(value) =>
                setConfig({ ...config, rotation: value[0] })
              }
              aria-valuemin={0}
              aria-valuemax={360}
